...
(0, _reactDom.render)(_react2.default.createElement(_map2.default, null), document.getElementById('map'));
...
var _payphones = __webpack_require__(30);

var _payphones2 = _interopRequireDefault(_payphones);

var _links = __webpack_require__(31);

var _links2 = _interopRequireDefault(_links);

var _hotspots_data = __webpack_require__(32);

var _hotspots_data2 = _interopRequireDefault(_hotspots_data);

var _payphones_data = __webpack_require__(33);

var _payphones_data2 = _interopRequireDefault(_payphones_data);

var _links_data = __webpack_require__(34);

var _links_data2 = _interopRequireDefault(_links_data);
...
var hotspotData = function hotspotData() {
...
var payphoneData = function payphoneData() {
  return axios.get('https://data.cityofnewyork.us/api/views/vzju-a4ks/rows.json?accessType=DOWNLOAD').then(function (res) {
    return res.data.data;
  }).catch(function (err) {
    return console.error(err);
  });
